...
data = esankhyiki.get_data("PLFS", {
  ...
  const datasets = [
    ...
    { id: "WPI", name: "Wholesale Price Index", desc: "Wholesale inflation, commodities" },
    ...
    { id: "UDISE", name: "Unified District Information System for Education", desc: "School education statistics" },
    ...
    { id: "NSS79", name: "NSS 79th Round", desc: "CAMS/AYUSH, education, health" },
