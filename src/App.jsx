    ...
    <div className="esk-container esk-header-inner">
      ...
      <nav>
        <ul className="esk-header-nav">
          ...
          <li><a href="https://github.com/nso-india/mospidata" target="_blank" rel="noreferrer">GitHub</a></li>
...
const Footer = () => (
  <footer className="esk-footer">
    ...
    <div className="esk-footer-links">
      ...
      <a href="https://github.com/nso-india/mospidata" target="_blank" rel="noreferrer">GitHub</a>
...
df = esankhyiki.get_data("GENDER", {
  ...
  return (
    <div className="esk-page">
            ...
            <div className="esk-hero-left">
              ...
              <div className="esk-install-row">
                ...
                <div className="esk-hero-links">
                  ...
                  <a href="https://github.com/nso-india/mospidata" target="_blank" rel="noreferrer" className="esk-btn esk-btn-outline">
      ...
      {/* ===== RELATED ===== */}
      <section className="esk-section esk-related-section ani">
        <div className="esk-container">
          <h2 className="esk-section-title">Related</h2>
          <div className="esk-related-grid">
            <a href="https://github.com/nso-india/esankhyiki-mcp" target="_blank" rel="noreferrer" className="esk-related-card">
              <div className="esk-related-icon">
              ...
              <h3>e-Sankhyiki MCP Server</h3>
              <p>Access MoSPI data through AI assistants like Claude, ChatGPT, and Cursor.</p>
            </a>
            <a href="https://api.mospi.gov.in" target="_blank" rel="noreferrer" className="esk-related-card">
              <div className="esk-related-icon">
              ...
              <h3>MoSPI Open APIs</h3>
              <p>Official API documentation and the e-Sankhyiki data portal.</p>
            </a>
          </div>
        </div>
      </section>
